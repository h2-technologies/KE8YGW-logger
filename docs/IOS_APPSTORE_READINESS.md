...
offline/sync/provider qualification remain incomplete. The Apple multicast
entitlement is approved, provisioned, and declared on the app target; see
[iOS Multicast Provisioning](IOS_MULTICAST_PROVISIONING.md) for the remaining
physical-device validation sequence.
