...
pub fn cloud_session_is_expired(session: &CloudSession, now: DateTime<Utc>) -> bool {
    session
        .expires_at
...
pub fn cloud_store_error(error: impl std::fmt::Display) -> CloudSyncError {
...
mod tests {
    use super::*;
    use crate::{CoreEventEnvelope, InMemoryLogbookEventStore, NewLogbookEvent};
    use serde_json::json;
