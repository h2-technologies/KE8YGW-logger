    ...
    pub fn mvp_default() -> Self {
        ...
        for (permission, category, display, risk, default_builtin, admin, reason) in [
            ...
            (
                ...
                true,
                false,
                "Register provider metadata for shared services.",
            ),
            (
                ...
                false,
                true,
                "Change provider configuration and credential references.",
            ),
            (
                ...
                true,
                false,
                "Enable configured service providers.",
            ),
            (
            ...
            (
                ...
                true,
                false,
                "Read non-official provider cache entries.",
            ),
            (
                ...
                true,
                false,
                "Write non-official provider cache entries.",
            ),
            (
                ...
                false,
                true,
                "Clear non-official provider cache entries.",
            ),
            (
                ...
                false,
                true,
                "Upload exported log data to external logbook services.",
            ),
            (
                PluginCapability::UploadConfirmationPull,
                "Uploads",
                "Pull Upload Confirmations",
                PermissionRiskLevel::High,
                false,
                true,
                "Fetch upload confirmations from external services.",
            ),
            (
                ...
                false,
                true,
                "Queue projected QSOs for provider-backed log upload.",
            ),
            (
                ...
                true,
                false,
                "View upload queue and status information.",
            ),
            (
                ...
                false,
                true,
                "Contact external logbook upload services.",
            ),
            (
                ...
                true,
                false,
                "View advisory spotting provider data.",
            ),
            (
                ...
                false,
                true,
                "Configure external spotting providers.",
            ),
            (
                PluginCapability::NetworkExternalSpotting,
                "Network",
                "External Spotting Network",
                PermissionRiskLevel::High,
                false,
                true,
                "Contact external spotting services.",
            ),
            (
                ...
                true,
                false,
                "View map panels and map tile providers.",
            ),
            (
                ...
                false,
                true,
                "Configure map providers and tile sources.",
            ),
            (
                ...
                false,
                true,
                "Contact external map tile, geocoding, or reverse geocoding services.",
            ),
            (
                ...
                true,
                false,
                "View advisory weather provider data.",
            ),
            (
                PluginCapability::NetworkExternalWeather,
                "Network",
                "External Weather Network",
                PermissionRiskLevel::Medium,
                false,
                true,
                "Contact external weather providers.",
            ),
            (
                ...
                true,
                false,
                "View advisory propagation provider data.",
            ),
            (
                PluginCapability::NetworkExternalPropagation,
                "Network",
                "External Propagation Network",
                PermissionRiskLevel::Medium,
                false,
                true,
                "Contact external propagation and space weather providers.",
            ),
            (
                PluginCapability::AutomationManage,
                "Automation",
                "Manage Online Automation",
                PermissionRiskLevel::High,
                false,
                true,
                "Configure scheduled online service tasks.",
            ),
            (
                ...
                true,
                false,
                "View generated online service notifications.",
            ),
            (
                PluginCapability::StationProfileView,
                "Station",
                "View Station Profiles",
                PermissionRiskLevel::Low,
                true,
                false,
                "View station profile defaults used by logger forms.",
            ),
            (
                PluginCapability::StationProfileManage,
                "Station",
                "Manage Station Profiles",
                PermissionRiskLevel::Medium,
                false,
                true,
                "Create and edit station profiles.",
            ),
            (
                ...
                true,
                false,
                "View configured station equipment.",
            ),
            (
                ...
                false,
                true,
                "Create and edit station equipment.",
            ),
            (
                ...
                true,
                false,
                "Apply active station profile defaults to logger proposals.",
            ),
            (
                ...
                true,
                false,
                "List credential labels and status without exposing secrets.",
            ),
            (
                ...
                false,
                true,
                "Store provider secrets in the configured credential backend.",
            ),
            (
                ...
                false,
                true,
                "Update stored provider credential secrets and safe metadata.",
            ),
            (
            ...
            (
                ...
                false,
                true,
                "Allow a provider to retrieve a secret by credential id.",
            ),
            (
                ...
                false,
                true,
                "Test whether a stored credential is available without revealing it.",
            ),
            (
                ...
                true,
                false,
                "View net templates, sessions, rosters, and reports.",
            ),
            (
                ...
                true,
                false,
                "Create recurring net templates.",
            ),
            (
                ...
                true,
                false,
                "Update recurring net templates.",
            ),
            (
            ...
            (
                ...
                true,
                false,
                "End or cancel directed net sessions.",
            ),
            (
                PluginCapability::NetCheckinCreate,
                "Net Control",
                "Create Net Check-ins",
                PermissionRiskLevel::Medium,
                true,
                false,
                "Add check-ins to active net sessions.",
            ),
            (
                PluginCapability::NetCheckinUpdate,
                "Net Control",
                "Update Net Check-ins",
                PermissionRiskLevel::Medium,
                true,
                false,
                "Edit check-in status, traffic flags, and notes.",
            ),
            (
                PluginCapability::NetCheckinDelete,
                "Net Control",
                "Delete Net Check-ins",
                PermissionRiskLevel::High,
                false,
                true,
                "Create tombstone events for net check-ins.",
            ),
            (
                ...
                true,
                false,
                "Create and update traffic items for a net.",
            ),
            (
...
mod tests {
    ...
    fn permission_registry_contains_required_permissions() {
        ...
        assert!(registry
            .get(&PluginCapability::ServiceProviderRegister)
            .is_some());
        assert!(registry.get(&PluginCapability::UploadLog).is_some());
        assert!(registry.get(&PluginCapability::SpottingView).is_some());
        assert!(registry.get(&PluginCapability::MapView).is_some());
        assert!(registry.get(&PluginCapability::WeatherView).is_some());
        assert!(registry.get(&PluginCapability::PropagationView).is_some());
        assert!(registry.get(&PluginCapability::CredentialCreate).is_some());
        assert!(registry.get(&PluginCapability::CredentialUse).is_some());
        assert!(registry.get(&PluginCapability::NetSessionStart).is_some());
        assert!(registry.get(&PluginCapability::NetCheckinCreate).is_some());
    }
