    ...
    pub fn default_registry() -> Self {
        let mut commands = vec![
            ...
            command(
                ...
                "Online Services",
                None,
                Some(WorkspaceId::OnlineServices),
            ),
            command(
                "online.upload.queue",
                "Queue Uploads",
            ...
            command(
                "online.health.refresh",
                "Refresh Online Provider Health",
                "Online Services",
                None,
                Some(WorkspaceId::OnlineServices),
            ),
            command(
                "online.dxcluster.open",
                "Open DX Cluster",
                "Online Services",
                None,
                Some(WorkspaceId::OnlineServices),
