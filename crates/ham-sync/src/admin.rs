...
//! record in [`crate::account`], so an operator administers exactly the server
...
/// than [`crate::account::MAX_HOSTED_ACCOUNT_RESPONSE_BYTES`].
...
mod tests {
    ...
    use super::*;
    use crate::account::{HostedAccountConfig, HostedAccountSnapshot};
