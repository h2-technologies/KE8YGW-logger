...
pub enum PluginCapability {
    ...
    NetworkExternalMap,
    WeatherView,
    NetworkExternalWeather,
    PropagationView,
    NetworkExternalPropagation,
    AutomationManage,
    NotificationView,
    StationProfileView,
...
impl PluginCapability {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Self::NetworkExternalMap => "network.external.map",
            Self::WeatherView => "weather.view",
            Self::NetworkExternalWeather => "network.external.weather",
            Self::PropagationView => "propagation.view",
            Self::NetworkExternalPropagation => "network.external.propagation",
            Self::AutomationManage => "automation.manage",
            Self::NotificationView => "notification.view",
...
impl<'de> Deserialize<'de> for PluginCapability {
        ...
        D: Deserializer<'de>,
    {
        ...
        Ok(match value.as_str() {
            ...
            "network.external.map" => Self::NetworkExternalMap,
            "weather.view" => Self::WeatherView,
            "network.external.weather" => Self::NetworkExternalWeather,
            "propagation.view" => Self::PropagationView,
            "network.external.propagation" => Self::NetworkExternalPropagation,
            "automation.manage" => Self::AutomationManage,
            "notification.view" => Self::NotificationView,
