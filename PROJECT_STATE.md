...
- Durable offline mutation queue schema and JSON support store in `ham-sync`,
  ...
  plus typed queue health and conflict-review display, v0.2 absent/legacy queue migration,
