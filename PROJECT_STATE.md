...
- Durable offline mutation queue schema and JSON support store in `ham-sync`,
  ...
  handling, shared accepted-prefix/rejected-tail queue recovery coverage, and
