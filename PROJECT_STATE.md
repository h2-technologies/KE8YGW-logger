...
- Durable offline mutation queue schema and JSON support store in `ham-sync`,
  ...
  revoked and expired cloud-auth user-action recovery coverage, and
  conflict-review display, v0.2 absent/legacy queue migration,
