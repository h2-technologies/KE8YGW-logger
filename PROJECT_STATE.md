...
- Sync has discovery, handshake, preview/pull/push verification models, durable
  ...
  networking for paired-device sync. Production iOS reciprocal LAN transport
  completion UX,
...
- Production iOS reciprocal LAN transport completion UX, stronger LAN
  ...
  snapshot/issue/accept/trust/rotate/revoke bridge and Sync workspace controls.
