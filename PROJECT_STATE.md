...
- Sync has discovery, handshake, preview/pull/push verification models, durable
  ...
  LAN peer identity mismatch rejection, pulled-event apply decoding, partial divergence
...
- Apple multicast entitlement/provisioning, stronger LAN
