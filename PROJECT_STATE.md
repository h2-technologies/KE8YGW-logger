...
- Sync has discovery, handshake, preview/pull/push verification models, durable
  ...
  fetch/apply coordination, unsigned LAN state request construction, LAN peer
...
- Production iOS reciprocal LAN pairing/address-discovery UX, stronger LAN
  ...
  snapshot/issue/accept/trust/rotate/revoke plus peer-identity-gated signed
  LAN pull bridge and Sync workspace controls.
