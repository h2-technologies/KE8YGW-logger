...
- Known critical and high-priority gaps:
  ...
  - Apple multicast entitlement/provisioning, stronger LAN key-exchange hardening, physical-device LAN validation, and end-to-end sync branch-review/reconciliation workflow qualification.
...
- Current release blockers:
  ...
  - iOS multicast entitlement/provisioning, stronger LAN key-exchange hardening, and physical-device validation.
