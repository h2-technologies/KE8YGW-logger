...
- Known critical and high-priority gaps:
  ...
  - Production reciprocal LAN pairing UX, stronger LAN key-exchange hardening, physical-device LAN validation, and corrective-event sync conflict-resolution UX.
