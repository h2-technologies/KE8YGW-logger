...
- Known critical and high-priority gaps:
  ...
  - Apple Developer account approval/provisioning for the declared multicast entitlement, physical-device LAN validation, and end-to-end sync branch-review/reconciliation workflow qualification.
...
- Current release blockers:
  ...
  - iOS multicast entitlement provisioning/approval and physical-device validation.
