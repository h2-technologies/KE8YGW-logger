...
- Production iOS automatic LAN address-discovery UX, stronger LAN
  key-exchange hardening, and physical-device validation beyond the automatic
  ...
  plus reciprocal peer-URL pairing and peer-identity-gated signed LAN pull
  bridge.
...
- Known critical and high-priority gaps:
  ...
  - Production iOS automatic LAN address-discovery UX, stronger LAN key-exchange hardening, physical-device LAN validation, and end-to-end sync branch-review/reconciliation workflow qualification.
...
- Current release blockers:
  ...
  - iOS automatic LAN address-discovery UX, stronger LAN key-exchange hardening, and physical-device validation.
