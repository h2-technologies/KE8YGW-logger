...
- Production reciprocal LAN pairing UX, LAN auth credential rotation/recovery,
  and physical-device validation beyond the automatic discovery/manual direct
  LAN HTTP peer paths and HMAC-SHA256 signed LAN read endpoint authorization.
...
- Known critical and high-priority gaps:
  ...
  - Production reciprocal LAN pairing UX, LAN auth credential rotation/recovery, physical-device LAN validation, and corrective-event sync conflict-resolution UX.
...
- Current release blockers:
  ...
  - LAN trust pairing UX, LAN auth credential rotation/recovery, and physical-device validation.
