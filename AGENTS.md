...
- Production LAN pairing UX and endpoint authentication beyond the automatic
  discovery/manual direct LAN HTTP peer paths.
...
- Known critical and high-priority gaps:
  ...
  - Production LAN pairing UX, LAN endpoint authentication, physical-device LAN validation, and corrective-event sync conflict-resolution UX.
...
- Current release blockers:
  ...
  - LAN trust pairing UX and endpoint authentication.
