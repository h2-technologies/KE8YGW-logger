...
- Known critical and high-priority gaps:
  ...
  - Production reciprocal LAN pairing UX, stronger LAN key-exchange hardening, physical-device LAN validation, and full guided sync branch-review/reconciliation UI.
